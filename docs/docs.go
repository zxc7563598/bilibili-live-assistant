...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/admin/export/download": {
            "get": {
                "description": "凭凭证下载。浏览器原生下载无法携带 Authorization 头，因此凭证即鉴权，\n与 /api/admin/live/messages/stream 用 query 传 token 是同一类做法。\n响应为流式 CSV，不是统一 JSON 信封；失败时返回纯文本与对应状态码。",
                "tags": [
                    "数据导出"
                ],
                "summary": "下载导出的 CSV",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/input.ExportTicketReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/resp.ExportTicketResp"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "input.ExportTicketReq": {
            ...
            "properties": {
                "columns": {
                    "description": "期望导出的列 key，顺序即 CSV 列顺序，须为模块声明过的列",
                    "type": "array",
                    "minItems": 1,
                    "items": {
                        "type": "string"
                ...
                "filters": {
                    "description": "筛选条件，字段与各模块列表接口同口径；为空表示不筛",
                    "type": "object"
                },
                "module": {
                    "description": "导出模块标识，与前端 MeCrud 的 export-module 一致",
                    "type": "string",
                    "example": "livedanmu"
                }
            }
        ...
        "resp.ExportTicketResp": {
            "type": "object",
            "properties": {
                "expires_at": {
                    "description": "凭证过期时间（unix 秒）",
                    "type": "integer",
                    "example": 1790000000
                },
                "filename": {
                    "description": "建议的文件名",
                    "type": "string",
                    "example": "弹幕记录_20260921_1530.csv"
                },
                "total": {
                    "description": "本次导出的命中行数",
                    "type": "integer",
                    "example": 1024
                },
                "url": {
                    "description": "下载地址（含凭证），前端据此触发浏览器原生下载",
                    "type": "string",
                    "example": "/api/admin/export/download?ticket=xxx"
                }
            }
        },
