...
type Product struct {
	...
	ProductType    enum.ProductType    `gorm:"type:smallint;not null;default:0;comment:商品类型"`
	...
	MinMemberLevel enum.MinMemberLevel `gorm:"not null;default:0;comment:大航海限购"`
	BaseModel
}
