...
const (
	CodeParamInvalid                  = 11601 // 请求参数不合法
	CodeCaptchaRequired               = 11602 // 请完成验证码验证
	CodeCaptchaFailed                 = 41601 // 验证码验证失败
	CodeCaptchaExpired                = 41602 // 验证码已过期，请刷新后重试
	CodeSystemBusy                    = 61601 // 系统繁忙，请稍后重试
)
