...
func RouteRegister(r *gin.Engine, rdb *redis.Client, handlers *Handlers, corsCfg config.CORSConfig, cryptoCfg config.CryptoConfig) *gin.Engine {
	...
	shopApi.POST("/liveuser/refresh", handlers.LiveUser.RefreshLogin)
	...
	shopApi.POST("/product/detail", middleware.UserAuth(rdb), handlers.Product.ShopDetails)
	shopApi.POST("/order/place", middleware.UserAuth(rdb), handlers.Order.PlaceOrder)
	shopApi.POST("/order/confirm", middleware.UserAuth(rdb), handlers.Order.GetOrderDraft)
	...
	shopApi.POST("/address/list", middleware.UserAuth(rdb), handlers.Address.ListAddresses)
	...
	shopApi.POST("/liveuser/assets", middleware.UserAuth(rdb), handlers.LiveUser.ListAssetsPage)
	...
	adminApi.POST("/auth/refresh", handlers.Admin.RefreshLogin)
	...
	adminApi.POST("/roles/permissions", middleware.AdminAuth(rdb), handlers.Role.GetPermissions)
	adminApi.POST("/menu/list", middleware.AdminAuth(rdb), handlers.Menu.GetMenuTree)
	adminApi.POST("/menu/validate", middleware.AdminAuth(rdb), handlers.Menu.CheckMenuExists)
	adminApi.POST("/menu/buttons", middleware.AdminAuth(rdb), handlers.Menu.ListMenuButtons)
	...
	adminApi.GET("/live/messages/stream", handlers.Live.StreamMessages)
	// 机器人配置路由（所有登录用户可访问）
	adminApi.POST("/robot/room/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetRoomConfig)
	adminApi.POST("/robot/room/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyRoomConfig)
	adminApi.POST("/robot/sign/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetSignConfig)
	adminApi.POST("/robot/sign/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplySignConfig)
	adminApi.POST("/robot/ad/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetAdConfig)
	adminApi.POST("/robot/ad/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyAdConfig)
	adminApi.POST("/robot/gift/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetGiftConfig)
	adminApi.POST("/robot/gift/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyGiftConfig)
	adminApi.POST("/robot/pk/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetPkConfig)
	adminApi.POST("/robot/pk/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyPkConfig)
	adminApi.POST("/robot/welcome/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetWelcomeConfig)
	adminApi.POST("/robot/welcome/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyWelcomeConfig)
	adminApi.POST("/robot/follow/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetFollowConfig)
	adminApi.POST("/robot/follow/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyFollowConfig)
	adminApi.POST("/robot/share/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetShareConfig)
	adminApi.POST("/robot/share/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyShareConfig)
	adminApi.POST("/robot/reply/get", middleware.AdminAuth(rdb), handlers.RobotConfig.GetReplyConfig)
	adminApi.POST("/robot/reply/apply", middleware.AdminAuth(rdb), handlers.RobotConfig.ApplyReplyConfig)
	...
	adminApi.POST("/liveuser/monthly", middleware.AdminAuth(rdb), handlers.LiveUser.GetUserMonthlyAnalysis)
	adminApi.POST("/liveuser/danmu", middleware.AdminAuth(rdb), handlers.LiveUser.GetUserDanmuAnalysis)
