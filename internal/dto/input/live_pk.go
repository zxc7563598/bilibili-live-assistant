...
type LivePkLogListPageReq struct {
	...
	// 排序方向 ascend/descend
	SortOrder *string `json:"sortOrder" binding:"omitempty,oneof=ascend descend" err:"oneof=11501" example:"descend" enums:"ascend,descend"`
	// 本直播间真实房间号，精确匹配
	...
	Result *int `json:"result" binding:"omitempty,oneof=-1 2" err:"oneof=11501" example:"2" enums:"-1,2"`
